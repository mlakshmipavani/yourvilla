...
$result = mysql_query("SELECT  `area`, `sqft`,`bhk`,`furnished`,`for_type`,`description`,`cost`,`available` FROM `property`,`house` WHERE for_type='sale' and property.pno=house.pno and available='yes'")
